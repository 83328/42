...
/*   Updated: 2024/04/04 14:35:08 by alimpens         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char *argv[], char *envp[])
{
	...
	while (1)
	{
		...
		if (ft_strcmp(stru->input, "") == 0)
			continue ;
		if (ft_strncmp(stru->input, "exit ", 5) == 0 || ft_strcmp(stru->input, "exit") == 0)
		{
			if (stru->input[5] != '\0')
			{
				if (stru->input[5] == ' ' || !ft_isdigit(stru->input[5]))
				{
					...
					exit_code = ft_atoi(stru->input + 5);
			}
			dprintf(2, "exit\n");
			exit(exit_code);
		}
		...
		if (!ft_strcmp(stru->reassembled_commands[0], ""))
			continue ;
		else if (ft_strncmp(stru->reassembled_commands[0], "cd", 2) == 0 && i == 1)
...
/* int	main(int argc, char *argv[], char *envp[])
{
	...
	while (1)
	{
		...
		if (strcmp(stru->input, "") == 0)
			continue ;
		if (ft_strncmp(stru->input, "exit ", 5) == 0 || strcmp(stru->input, "exit") == 0)
		{
			if (stru->input[5] != '\0')
			{
				if (stru->input[5] == ' ' || !ft_isdigit(stru->input[5]))
