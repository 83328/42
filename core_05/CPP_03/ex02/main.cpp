...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/07/30 10:52:38 by alimpens          #+#    #+#             */
/*   Updated: 2024/07/30 11:02:30 by alimpens         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void) 
{
	...
	FragTrap eee("Fragster 1");
	FragTrap fff("Fragster 2");
	...
	// Testing FragTrap specific functionalities
	eee.attack("Monster 1");
	std::cout << '\n';
	fff.takeDamage(7);
	std::cout << '\n';
	eee.highFivesGuys();
